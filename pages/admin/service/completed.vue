  ...
  >
    ...
    <section class="w-[90%] h-[80%] flex flex-col gap-4">
      ...
      >
        ...
        <li
          class="row-start-2 row-span-2 col-start-10 col-span-4 grid place-items-center tracking-wider text-center rounded-2xl bg-[#4CAF50] text-white font-semibold uppercase text-sm"
        >
          {{ solicitacao.status }}
        </li>
